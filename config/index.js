export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx13985d6c419dac8a",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a9ca96ca507772e3cf01240ad0194529",
  ...
  USERS: [
    {
      ...
      id: "oq_Ea62AKaeMvy-ab8kEawtoYU1Y",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "R2EXlp6QZp2hLiPmO4KMUvvPy_3nTSuciximVKePVKw",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "南宁",
      // 新历生日, 仅用作获取星座运势, 格式必须
      horoscopeDate: '2002-05-12',
      // 获取什么时候的星座运势，可选：['今日', '明日', '本周', '本月', '今年'], 留空则随机
      horoscopeDateType: '今日',
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
      openUrl: "https://wangxinleo.cn",
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: ["type": "*纪念日", "name": "宝贝", "year": "2020", "date": "0202"]
